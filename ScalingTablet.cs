//Этот код формировал таблички их фнешний вид и следил за рапсположением важных элементах во время иззмениения размеров
...
public class ScalingTablet : MonoBehaviour
{
    ...
    //TODO: Äîðàáîòàé äåëåíèå à òàì çà êíîïêè è ââîä òåêñòà ó íàìáåðà è íîòåòàáëè÷êè
    //íó è ïî èòîãó ìîæíî êîí÷åíî âñåõ êíîïîê ðåäåçàéí ñäåëàòü îñîáåííî ÷òî êàñàòåëüíî ìåíþ íàøåãî
    public float rL, rW;
    public void Start()
    {
    ...
    public Vector3 replacementSaze(Vector3 R, Vector3 L, bool check = false)
    {
        ...
        //Ïîëó÷åíèå èòîãîâûõ ðàçìåðîâ 
        float l = R.x + L.x + 6.2f + Rp;
        float w = v.y + 1;
        float zA = v.z - 0.001f;
        Debug.Log("length: " + l + ", width: " + w);

        //Ïåðåäà÷à èõ â form è frame è ò.ä.
