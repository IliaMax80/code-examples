#По собственому желданию я решил создать игру Сапер при помощи билиотеки tkinter
#Хочу заметить что во время написание кода акцент делался на то смогу ли я сам восооздать игровую логику, а не на внешний вид игры 
from tkinter import *
import random
from math import *
