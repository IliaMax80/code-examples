//Компонент для перемещений табличек мышкой
...
public class Taskability : MonoBehaviour
{
    ...
    public void Translate(Vector3 a)
    {
        ...
        if (GetComponent<OperatorScript>())
        {
            ...
            // íå íóæåí òàê êàê given è òàê ïîä ðàçìåð ïîäñòðàèâàåòüñÿ:  + GetComponent<ScalingTablet>().smeshX
        }
        else
        {
            transform.position = StartVector;
